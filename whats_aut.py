    ...
    def __init__(self):
        ...
        for i in range(1, self.sheet1.nrows):
            ...
            try:
                ...
                print('No se envió')
                de = self.driver.find_element(By.XPATH, '//*[@id="side"]/div[1]/div/div/span/button/span')
                de.click()
                continue
